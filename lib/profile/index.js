...
function defaults ( ) {
  var profile = {
    ...
    , remainingCarbsFraction: 1 // fraction of carbs we'll assume will absorb over 4h if we don't yet see carb absorption
    , remainingCarbsCap: 120 // max carbs we'll assume will absorb over 4h if we don't yet see carb absorption
    ...
    , enableSMB_with_bolus: true // enable supermicrobolus for DIA hours after a manual bolus
